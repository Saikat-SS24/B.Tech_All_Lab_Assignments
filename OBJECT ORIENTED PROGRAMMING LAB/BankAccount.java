...
class SavingsAccount {
    ...
    public String toString() {
        return ("ID: " + this.id + ", Name: " + this.name + ", Address: " + this.address + ", PAN Number: " + this.panNumber + ", Balance: " + this.balance + ", Account type: Savings");
    }
...
class HomeLoanAccount {
    ...
    public String toString() {
        return ("ID: " + this.id + ", Name: " + this.name + ", Address: " + this.address + ", PAN Number: " + this.panNumber + ", Balance: " + this.balance + ", Account type: Home Loan");
    }
...
class DematAccount {
    ...
    public String toString() {
        return ("ID: " + this.id + ", Name: " + this.name + ", Address: " + this.address + ", PAN Number: " + this.panNumber + ", Balance: " + this.balance + ", Account type: Demat");
    }
...
public class BankAccount {
    public static void main(String[] args) {
        SavingsAccount acc1 = new SavingsAccount(124, "Saikat Sheet", "Kolkata", 324546, 50000);
        acc1.withdraw(60000);
        acc1.deposit(40000);
        acc1.withdraw(60000);
        System.out.println(acc1);

        HomeLoanAccount acc2 = new HomeLoanAccount(123, "Tuhin Bhowmik", "Bangalore", 56721, 30000, 20000);
        acc2.withdraw(60000);
        acc2.deposit(40000);
        acc2.withdraw(60000);
